...
BMVMR_POCov <- function(Outcome, SD, XCovariate, WCovariate, Treat, Trial, Npt, c0, dj0, d0, s0, nu0, Omega0, Sigma0, K, T, fmodel, ndiscard, nskip, nkeep, R_stepsize, Rho_stepsize, delta_stepsize, verbose) {
    .Call(`_metapack_BMVMR_POCov`, Outcome, SD, XCovariate, WCovariate, Treat, Trial, Npt, c0, dj0, d0, s0, nu0, Omega0, Sigma0, K, T, fmodel, ndiscard, nskip, nkeep, R_stepsize, Rho_stepsize, delta_stepsize, verbose)
}
