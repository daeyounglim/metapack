	...
	*******************/
	...
	}
	{
		...
		for (int idiscard = 0; idiscard < ndiscard; ++idiscard) {
			...
			vec vRhop = vRho + SS * U;
			// log-likelihood difference
			double ll_diff = loglik_vRho_m4(vRhop, delta, WCovariate, SD, resid, Npt, vRtk, Trial, gamR, d0, nu0, N, J, K, T, Sigma0inv) - 
							loglik_vRho_m4(vRho, delta, WCovariate, SD, resid, Npt, vRtk, Trial, gamR, d0, nu0, N, J, K, T, Sigma0inv);
			...
			if (std::log(::unif_rand()) < ll_diff) {
				...
				double ll_diff_zystar = loglik_vRho_m4(zzz, delta, WCovariate, SD, resid, Npt, vRtk, Trial, gamR, d0, nu0, N, J, K, T, Sigma0inv)
										 - loglik_vRho_m4(ystar, delta, WCovariate, SD, resid, Npt, vRtk, Trial, gamR, d0, nu0, N, J, K, T, Sigma0inv);
				double log1pzystar = std::log1p(-std::min(1.0, std::exp(ll_diff_zystar)));
				double ll_diff_zx = loglik_vRho_m4(zzz, delta, WCovariate, SD, resid, Npt, vRtk, Trial, gamR, d0, nu0, N, J, K, T, Sigma0inv)
										 - loglik_vRho_m4(vRho, delta, WCovariate, SD, resid, Npt, vRtk, Trial, gamR, d0, nu0, N, J, K, T, Sigma0inv);
